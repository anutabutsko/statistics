...
# Problem 3
1. 
b)  We get result E[Z] = 0 from subtracting the mean, which shifts the whole data set so that the average is lined up with zero. We do this by subtracting the original average from every variable: X - mu. Now, if we find the average of this shifted set it will be zero because every variable has been lined up around mean 0.

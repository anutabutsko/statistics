...
Mean: Mean is very close to zero, which is the true value of mean since our samples range between -2 to 2 with the mean 0.  
Standard deviation: values of sd 0.0352 and theoretical sd 0.0368 are very close to each other. Data deviates slightly from the mean. Most of the data located withing 3 * 0.0352 = 0.1056 from the mean.  
a)  
```{r}
problem_1(2)
```  
...
Mean value is close to true mean.  
...
c) upper bound: 0.55 + (0.03517812 x 3) = 0.6555344  
lower bound: 0.55 - (0.03517812 x 3) = 0.4444656  
Probability of not getting the majority of votes is 0.5 - 0.4445 = 0.0555 or 5.5 %.  
...
b) Considering the mean 0.1 which equals to 10 cents and sd of 0.1, winning 1 dollar would lie somewhere within 10 standard deviations from the wean. Which is highly highly extremely unlikely.  
